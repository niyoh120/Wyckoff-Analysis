...
BUILTIN_PROMPT_TEMPLATES: dict[str, PromptTemplate] = {
    "daily": PromptTemplate(
        ...
        prompt=(
            ...
            '4. 调用 query_history(source="attribution", limit=1) 查看策略治理器、升降权建议、latest_source/remote_error、latest_operator_summary、next_action、promotion_status、promotion_checklist、latest_execution_state 和 latest_operations。\n'
