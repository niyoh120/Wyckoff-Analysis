...
| 🔬 **Wyckoff Funnel** | 多层漏斗筛选：剥离垃圾 → 三通道强弱甄别（主升/潜伏/吸筹）→ Markup 识别 → 板块共振 → 威科夫狙击 → Exit 信号 |
...
| Layer 2 | **三通道强弱甄别** | ① **主升通道**：MA50 > MA200 + RPS50/RPS120 强势；② **潜伏通道**：长强短弱（RPS120 高、RPS50 低）回到年线附近；③ **吸筹通道**：低位区 + 横盘振幅小 + 量能萎缩 + 均线胶着，捕捉 Wyckoff Phase A/B/C |
...
| Layer 5 | **Exit 信号** | 止盈目标（从吸筹低点 +50%）、风控止损（-8%）、Distribution 高位缩量预警 |
