"""US backtest report aggregation and Feishu card builders."""
...
@dataclass(frozen=True)
class UsBacktestNotifyRequest:
    artifacts_dir: str = "artifacts"
    output: str = "docs/BACKTEST_US_REPORT.md"
    run_url: str = ""
    top_n: str = "2"
    webhook_url: str = ""


def run_us_backtest_notification(request: UsBacktestNotifyRequest) -> int:
