...
const capabilityCopy = {
  'zh-CN': {
    ...
    webTitle: 'Web 端已经接入',
    webItems: ['单股 320 日日线结构图、价值快照、AI 报告与本地历史', '多股对抗的相对强弱、叠加/分图、价值面校准与本地历史', '持仓诊断支持数据库持仓和手动持仓，结果保存在当前浏览器', '白名单形态跟踪、尾盘记录、批量行情导出、模型和数据源配置'],
  ...
  'en-US': {
    ...
    webItems: ['Single-stock 320-day chart, value snapshot, AI report, and local history', 'Stock battle with relative strength, overlay/separate charts, value calibration, and local history', 'Portfolio diagnosis for database or manual positions, with browser-local result history', 'Allowlisted pattern tracking, tail-buy logs, batch market-data export, model and data-source settings'],
