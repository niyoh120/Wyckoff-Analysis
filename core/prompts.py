...
- "策略归因""归因报告""哪些信号要降权""shadow 新增移除" → **策略归因**（query_history source="attribution"），必须先读取 latest_source/remote_error，再读取 latest_execution_state、next_action、promotion_status、promotion_checklist 和 latest_operations 后再回答
