"""CLI entrypoint for US backtest strategy replay."""

from __future__ import annotations

import argparse

from workflows.us_backtest_strategy_replay import run_us_strategy_replay
...
def main() -> int:
    return run_us_strategy_replay(parse_args())
